...
export async function readRunnable(filepath) {
    ...
    function findARXML(filePath, format, pathlist) {
        ...
        filelist.forEach((fileitem) => {
            filePath1 = path.join(filePath, fileitem);
            // console.log(filePath1)
            stats = statSync(filePath1);
    ...
    function main() {
        ...
        let filepath = extractFileSync(`D:\\education\\CSP1`, 'Asw');
        let xmlPath = findARXML(filepath, 'arxml', []);
        console.log(xmlPath)
